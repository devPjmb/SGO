...
namespace common\components\kartik\colorinput;
...
use yii\web\View;
use common\components\kartik\base\Html5Input;
use common\components\kartik\base\Html5InputAsset;
use common\components\kartik\base\TranslationTrait;
