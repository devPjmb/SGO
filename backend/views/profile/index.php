	 	...
	 	<div class="row-fluid">
                <div class="col-sm-5">
                	<div class="row">
	                	<div class="col-sm-7">
			                <a href="#">
						        <img src="<?= $ModelUserAccount->PhotoUrl? Yii::getAlias('@proyect').'/images/profile/'.$ModelUserAccount->PhotoUrl : Yii::getAlias('@proyect').'/images/profile/UserDefault.svg';?>" alt="Imagen de Perfil" class="img-responsive img-circle" id="ViewProfileIMG"	style="margin: 0 auto 10px;">
						    </a> 
						</div>
					</div>
					<div class="row-fluid">
