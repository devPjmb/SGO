...
<div class="container-fluid">
    ...
    <h1><?=($ModelsMenuByRole->isNewRecord)? 'Create Menu' : 'Update Menu'; ?> </h1>
     <div class="row-fluid">
            ...
            <div class="customer-form">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <?= $form->field($MenuModel, 'Type')->dropDownList(['0' => 'Menu Con Sub menus', '1'=>'Menu Simple' ],['class'=>'typemenu form-control']) ?>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="container-items-role"><!-- widgetContainer -->
                            <div class="item-role panel panel-default"><!-- widgetBody -->
                                <div class="panel-heading">
                                    <h3 class="panel-title pull-left">Select Rol</h3>
                        ...
                        <?php foreach ($PagesModel as $i => $modelPages): ?>
                            <div class="item panel panel-default"><!-- widgetBody -->
                                <div class="panel-heading">
                                    <h3 class="panel-title pull-left">Pages</h3>
                ...
                <div class="form-group">
                    <?= Html::submitButton($ModelsMenuByRole->isNewRecord ? 'Create' : 'Update', ['class' => 'btn btn-primary click-confirm', 'style'=>'width:100%;',
                            "tittle-alert" => $ModelsMenuByRole->isNewRecord ? 'Create Menu' : 'Update Menu',
                            "text-alert" => $ModelsMenuByRole->isNewRecord ? 'It´s a point to create a new menu Do you want to continue?' : 'It´s a point to Update the menu ['.$MenuModel->MenuName.'] Do you want to continue?',
